...
--  1. Use ROW_NUMBER() — always assigns unique numbers 
...
-- 2. Use RANK() — gives same rank for ties, with gaps
...
-- 3. Use DENSE_RANK() — gives same rank for ties, no gaps
