...
namespace CalcLibrary
{
    ...
    {
        double result = 0;
        public double Addition(double a, double b) => result = a + b;
        public double Subtraction(double a, double b) => result = a - b;
        public double Multiplication(double a, double b) => result = a * b;
